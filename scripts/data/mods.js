export const MODS = {
    ...
    "1.12.2": {
        ...
        clumps: {
            name: "Clumps",
            version: "3.1.2",
            url: "https://www.curseforge.com/minecraft/mc-mods/clumps",
            description: "объединяет сферы опыта, уменьшая лаги и ускоряя их подбор."
        },
        codechickenlib: {
        ...
        enchantmentdescriptions: {
            ...
            version: "1.1.15",
            url: "https://www.curseforge.com/minecraft/mc-mods/enchantment-descriptions",
            description: "добавляет описания зачарований во всплывающие подсказки предметов."
        },
        endercore: {
            name: "EnderCore",
            version: "0.5.78",
        ...
        fastworkbench: {
            name: "FastWorkbench",
            version: "1.7.4",
            url: "https://www.curseforge.com/minecraft/mc-mods/fastworkbench",
            description: "оптимизирует верстаки и уменьшает нагрузку от пересчёта рецептов крафта."
        },
        forgelin: {
            name: "Forgelin",
            version: "1.8.4",
        ...
        fpsreducer: {
            name: "FPS Reducer",
            version: "1.20",
            url: "https://www.curseforge.com/minecraft/mc-mods/fps-reducer",
            description: "уменьшает FPS и нагрузку, когда игра находится в фоне или игрок бездействует."
        },
        geckolib: {
            name: "GeckoLib",
            version: "3.0.31",
        ...
        inventorytweaks: {
            ...
            version: "1.63",
            url: "https://www.curseforge.com/minecraft/mc-mods/inventory-tweaks",
            description: "добавляет сортировку инвентаря и удобное управление предметами."
        },
        ironchest: {
            name: "Iron Chests",
            version: "7.0.72.847",
        ...
        betterfps: {
            name: "BetterFps",
            version: "1.4.8",
            url: "https://www.curseforge.com/minecraft/mc-mods/betterfps",
            description: "повышает производительность за счёт оптимизации математических вычислений и рендеринга."
        },
        chunkloaders: {
            name: "Chunk Loaders",
            version: "1.2.9a",
        ...
        conarm: {
            ...
            version: "1.2.5.10",
            url: "https://www.curseforge.com/minecraft/mc-mods/constructs-armory",
            description: "добавляет создание и модификацию брони по системе Tinkers' Construct."
        },
        crafttweaker: {
            name: "CraftTweaker",
            version: "4.1.20.715",
